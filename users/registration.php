	...
	<body>
		<div id="page">
			...
			<form method="post">
				...
				<label>Courriel : </label><input type="email" name="email1" required><br>
				<label>Confirmation courriel : </label><input type="email" name="email2" required><br>
				<label>Mot de passe : </label><input type="password" name="pwd1" required><br>
				<label>Confirmation mot de passe : </label><input type="password" name="pwd2" required><br>
